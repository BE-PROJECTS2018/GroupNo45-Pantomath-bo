...
def intensity(sound):
	...
	row.extend([avg_intensity, max_intensity, min_intensity, range_intensity, sd_intensity])
...
def pitch(sound):
	...
	row.extend([avg_pitch, max_pitch, min_pitch, range_pitch, sd_pitch])
...
def formant(sound):
	...
	row.extend([mean_f1, mean_f2, mean_f3, mean_b1, mean_b2, mean_b3, sd_f1, sd_f2, sd_f3, 
...
def spectrum(sound):
	...
	row.append(band_energy_spectrum)
